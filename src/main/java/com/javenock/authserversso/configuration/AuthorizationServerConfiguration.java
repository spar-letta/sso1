...
import com.javenock.authserversso.security.grantPassword.AuthorizationGrantTypePassword;
import com.javenock.authserversso.security.grantPassword.GrantPasswordAuthenticationProvider;
import com.javenock.authserversso.security.grantPassword.OAuth2GrantPasswordAuthenticationConverter;
        ...
        RegisteredClient demoClient = RegisteredClient.withId(UUID.randomUUID().toString())
            ...
            .tokenSettings(
                TokenSettings.builder()
                    ...
                    .accessTokenTimeToLive(Duration.ofMinutes(34300))
                    .refreshTokenTimeToLive(Duration.ofMinutes(34600))
                    .authorizationCodeTimeToLive(Duration.ofMinutes(23440))
